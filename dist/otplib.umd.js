(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.otp = {}, global.node_crypto));
})(this, (function (exports, node_crypto) { 'use strict';

  // ### Function: Create one-time pad based on crypto.getRandomValues
  function createOnetimePad (length) {
    let otp = '';
    let array = new Uint8Array(128);
    node_crypto.getRandomValues(array);
